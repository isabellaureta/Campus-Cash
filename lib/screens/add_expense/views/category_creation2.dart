...
Future getCategoryCreation2(BuildContext context) {
  ...
  return showDialog(
      ...
      builder: (ctx) {
        ...
        Category2 category2 = Category2.empty;

        return BlocProvider.value(
          value: context.read<CreateCategoryBloc2>(),
          child: StatefulBuilder(
            builder: (ctx, setState) {
              return BlocListener<CreateCategoryBloc2, CreateCategoryState2>(
                listener: (context, state) {
                  if(state is CreateCategorySuccess2) {
                    Navigator.pop(ctx, category2);
                  } else if (state is CreateCategoryLoading2) {
                    setState(() {
                      isLoading = true;
                    });
                  }
