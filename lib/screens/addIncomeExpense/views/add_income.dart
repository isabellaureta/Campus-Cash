...
class _AddIncomeState extends State<AddIncome> {
  ...
  Category2(icon: 'Allowance', name: 'Allowance', color: 0xFFE57373, categoryId2: '001'),
  Category2(icon: 'Scholarship', name: 'Scholarship', color: 0xFF81C784, categoryId2: '002'),
  Category2(icon: 'Grants', name: 'Grants', color: 0xFF64B5F6, categoryId2: '003'),
  Category2(icon: 'Part-Time Job', name: 'Part-Time Job', color: 0xFFFFD54F, categoryId2: '004'),
  Category2(icon: 'Freelance', name: 'Freelance', color: 0xFFBA68C8, categoryId2: '005'),
  Category2(icon: 'Stipends', name: 'Stipends', color: 0xFF4DB6AC, categoryId2: '006'),
  Category2(icon: 'Salary', name: 'Salary', color: 0xFFAED581, categoryId2: '0077'),
  Category2(icon: 'Internships', name: 'Internships', color: 0xFF7986CB, categoryId2: '008'),
  Category2(icon: 'Loans', name: 'Loans', color: 0xFF4DB6AC, categoryId2: '009'),
  Category2(icon: 'Savings', name: 'Savings', color: 0xFF4DB6AC, categoryId2: '100'),
  Category2(icon: 'Gifts', name: 'Gifts', color: 0xFF4DB6AC, categoryId2: '101'),
  Category2(icon: 'Awards', name: 'Awards', color: 0xFF4DB6AC, categoryId2: '102'),
  Category2(icon: 'Investments', name: 'Investments', color: 0xFF4DB6AC, categoryId2: '103'),
  Category2(icon: 'Business', name: 'Business', color: 0xFF4DB6AC, categoryId2: '104'),
  Category2(icon: 'Refunds', name: 'Refunds', color: 0xFF4DB6AC, categoryId2: '105'),
  Category2(icon: 'Crypto', name: 'Crypto', color: 0xFF4DB6AC, categoryId2: '106'),
  Category2(icon: 'Pre-owned Sales', name: 'Pre-owned Sales', color: 0xFF4DB6AC, categoryId2: '107'),
  Category2(icon: 'Others', name: 'Others', color: 0xFF4DB6AC, categoryId2: '108'),
];
